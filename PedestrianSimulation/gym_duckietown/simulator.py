...
class Simulator(gym.Env):
    ...
    def __init__(
        ...
        # Start angle
        self.user_start_angle = user_start_angle
    ...
    def reset(self):
        ...
        for _ in range(MAX_SPAWN_ATTEMPTS):
            ...
            if self.user_start_angle:
                propose_angle = self.user_start_angle
            else:
        ...
        for obj_idx, desc in enumerate(map_data.get('objects', [])):
            ...
            if static:
                ...
                if kind == "duckiebot":
                    ...
                    obj = DuckieObj(obj=obj_desc,
                                    domain_rand=self.domain_rand,
                                    safety_radius_mult=SAFETY_RAD_MULT,
                                    walk_distance=2 * self.road_tile_size)
                else:
